...
TOTAL_RODADAS = 200   # 200 ciclos de ataque (dragão + você)


def atacar_dragao():
    """Executa o ataque automático contra o Dragão em DDTank."""
    rodada = 0
    ...
    while rodada < TOTAL_RODADAS:
        time.sleep(6)  # Tempo do ataque do dragão (implícito)
